						...
						<div className="modal-body p-6">
							...
							<div className="dark:border-jacarta-600 border-jacarta-100 relative mb-2 flex items-center overflow-hidden rounded-lg border">
								<div className="border-jacarta-100 bg-jacarta-50 flex flex-1 items-center self-stretch border-r px-2">
									...
									<span className="font-display text-jacarta-700 text-sm">NEAR</span>
								</div>
							...
							<div className="text-right flex justify-between pt-6">
								<span className="dark:text-jacarta-400 text-sm">Balance:</span>
								<span className="dark:text-jacarta-400 text-sm"> {prettyBalance(near?.currentUser?.balance?.total||"0")} Ⓝ </span>
							</div>
							<div className="text-right flex justify-between">
								<span className="dark:text-jacarta-400 text-sm">offer: </span>
								<span className="dark:text-jacarta-400 text-sm">{ETHAmount?ETHAmount:0} Ⓝ</span>
							</div>
						...
						<div className="modal-footer">
							<div className="flex items-center justify-center space-x-4">
								<button
									...
									onClick={() => props.handleOffer(ETHAmount)}
								>
									Place Bid
								</button>
							</div>
