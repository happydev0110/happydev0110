				...
				<div className="modal-dialog max-w-2xl">
					<div className="modal-content">
						...
						<div className="modal-body p-6">
							...
							{/* <!-- Total --> */}
							<div className="dark:border-jacarta-600 border-jacarta-100 mb-2 flex items-center justify-between pt-5 py-2.5">
								...
								<div className="ml-auto">
									<span className="flex items-center whitespace-nowrap">
										...
										<span className="text-green font-medium tracking-tight">{prettyBalance(props.price || "0")} Ⓝ</span>
									</span>
						...
						<div className="modal-footer">
							<div className="flex items-center justify-center space-x-4">
								<button
									...
									onClick={()=>props.handleBuy( props.price || "0")}
								>
									Buy
								</button>
							</div>
