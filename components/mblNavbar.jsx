...
import { closeMblMenu, shopModalShow } from "../redux/counterSlice";
...
const MblNavbar = ({ theme }) => {
  ...
  useEffect(() => {
    ...
    if (navItemValue === 0) {
      setnavText("Home")
    } else if (navItemValue > 1 && navItemValue <= 3) {
      setnavText("Marketplace");
    } else if (navItemValue > 3 && navItemValue <= 5) {
      setnavText("Insights");
    } else if (navItemValue === 6) {
      setnavText("launchPad");
    } else if (navItemValue === 7) {
      setnavText("drops");
    } else if (navItemValue === 8) {
      setnavText("profile")
    }
  ...
  const homenavData = [
    {
      id: 2,
      text: "Collections",
      url: "/explore_collection",
    },
    // {
    //   id: 3,
    //   text: "user",
    //   url: "/user/whiteapple.near",
    // },
  ];
        ...
        <Link href="/">
          <a>
            ...
            <img
              ...
              alt="Xhibiter | NFT Marketplace"
              className="max-h-16 dark:block hidden"
            />
          </a>
        </Link>
      ...
      <nav className="navbar w-full">
        <ul className="flex flex-col lg:flex-row">
          <li className="js-nav-dropdown group relative">
            ...
            >
              <span className={navText === "Marketplace" ? "text-accent" : ""}>
                Marketplace
              </span>
          ...
          <li className="js-nav-dropdown group relative">
            <button
              ...
              onClick={(e) => handleItemDropdown(e)}
            >
              <span className={navText === "Insights" ? "text-accent" : ""}>
                Insights
              </span>
            ...
            <Link href="/drops">
              ...
              >
                <button
                  className={
                    router.asPath === "/drops"
                      ? "text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-2"
                      : "text-jacarta-700 font-display hover:text-accent focus:text-accent dark:hover:text-accent dark:focus:text-accent flex items-center justify-between py-3.5 text-base dark:text-white lg:px-2"
                  }
                >
                  <span className={navText === "drops" ? "text-accent" : ""}>
                    MintCalender
                  </span>
                </button>
              </a>
